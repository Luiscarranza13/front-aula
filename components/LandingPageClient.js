...
const seoPillars = [
  {
    title: 'Aula virtual para colegios',
    description: 'Centraliza clases, tareas, evaluaciones y seguimiento académico para instituciones que necesitan control y orden.',
  },
  {
    title: 'Plataforma educativa para academias',
    description: 'Organiza grupos, recursos, foros y comunicación docente-estudiante desde una sola interfaz web.',
  },
  {
    title: 'Software de gestión educativa',
    description: 'Combina campus virtual, reportes, administración de usuarios y operaciones académicas en línea.',
  },
];
  ...
  const structuredData = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        featureList: [
          'Gestión de cursos',
          'Tareas y evaluaciones en línea',
          'Foros de discusión y comunicación educativa',
          'Panel administrativo para instituciones',
          ...
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.22em] text-slate-500">
                SEO y propuesta de valor
              </p>
              <h2 className="mt-3 text-3xl font-extrabold tracking-tight text-slate-900">
                Plataforma educativa, aula virtual y software de gestión educativa en una sola solución
              </h2>
              <p className="mt-4 text-base leading-7 text-slate-600">
                NovaTec se posiciona para búsquedas con alta intención como <strong>aula virtual</strong>,
                <strong> plataforma educativa</strong>, <strong>campus virtual</strong>,
                <strong> LMS para colegios</strong> y <strong>software de gestión educativa</strong>,
                combinando operación académica, comunicación y seguimiento del aprendizaje.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="pt-8 border-t border-slate-100 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6 text-sm text-slate-400">
              <Link href="/help" className="hover:text-slate-700 transition-colors">Términos</Link>
              <Link href="/help" className="hover:text-slate-700 transition-colors">Privacidad</Link>
              <Link href="/help" className="hover:text-slate-700 transition-colors">Cookies</Link>
            </div>
          </div>
        </div>
      </footer>
